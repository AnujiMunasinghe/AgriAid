    ...
    id: 1,
        ...
        actions: {
             weeding: {
                         ...
                         description:'eeding for Capsicum involves removing unwanted plants (weeds) from the area around the Capsicum plants. Weeds can compete with Capsicum plants for nutrients, water, and sunlight, leading to reduced growth and yield. Therefore, weeding is an important practice to ensure the healthy growth and optimal yield of Capsicum plants.',
                         step:'check'
                      },
        ...
        growth : [
            {
                ...
                ambient: 'During the seeding stage, the temperature may range from 25-30°C, the RH may range from 60-70%, the pH may range from 5.5-6.5 and the EC may range from 0.8-1.2 mS/cm.'
            },
